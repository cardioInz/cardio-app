...
import android.databinding.repacked.google.common.collect.Table;
...
//            TableUtils.createTableIfNotExists(getDbHelper().getConnectionSource(), OtherSymptompsRecord.class);
